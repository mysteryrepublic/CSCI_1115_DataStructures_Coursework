 ...
 * 05-16-2019
 * Description: 
 * (Add new methods in BST) Using Exercise25_1, add the following new methods in BST.
...
public class Exercise25_01 {
	...
	public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
		...
		public void breadthFirstTraversal() {
			...
			TreeNode<E> current;
			while(!queue.isEmpty()){
				current = (TreeNode<E>) queue.remove(0);
		...
		//this is the end of where I am changing the code
